...
// Delete User
router.delete("/user/:id", Authorization.Authenticated, Authorization.SuperUser, UserController.DeleteUser)
...
// Router Menu Access
router.post("role-menu-access", Authorization.Authenticated, Authorization.SuperUser, RoleMenuAccessController.CreateAccess);
...
router.patch("role-menu-access/:id", Authorization.Authenticated, Authorization.SuperUser, RoleMenuAccessController.UpdateAccess);
